...
const jogos: Jogo[] = [
  { id: 1, timeCasa: 'Flamengo', timeVisitante: 'Palmeiras', placarCasa: 2, placarVisitante: 1, competicao: 'Brasileirão Série A', minuto: "78'" },
  { id: 2, timeCasa: 'Real Madrid', timeVisitante: 'Barcelona', placarCasa: 1, placarVisitante: 1, competicao: 'La Liga', minuto: "63'" },
  { id: 3, timeCasa: 'Brasil', timeVisitante: 'Argentina', placarCasa: 2, placarVisitante: 0, competicao: 'Copa do Mundo 2026', minuto: "45'" },
];
    ...
    <section id="jogos" className="px-6 py-12 bg-[#0D0D0D]">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="text-xs font-semibold text-[#FF3B30] uppercase tracking-widest mb-1">Tempo Real</p>
            <h2 className="text-2xl font-bold text-white">🔴 Jogos Ao Vivo</h2>
          </div>
          <button className="text-sm text-[#0066FF] hover:text-white transition-colors font-medium">Todos os jogos →</button>
        </div>
